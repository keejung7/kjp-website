...
const Contact = () => {
  // code borrowed from web3forms documentation
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "c032cb78-647e-46a0-8512-9e12a7132ecc");
  ...
  return (
    ...
    >
      ...
      <form onSubmit={onSubmit} className="max-w-2xl mx-auto">
        ...
        <p className="text-center max-w-2xl mx-auto mt-5 mb-12 font-ovo mt-4">
          {result}
        </p>
      </form>
    </div>
